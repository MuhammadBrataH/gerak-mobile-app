...
class _PhoneUpdateViewState extends State<PhoneUpdateView> {
  ...
  void initState() {
    ...
    _phoneController = TextEditingController(
      text: (args?['phone'] as String?) ?? '087421712412',
    );
  }
          ...
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _PhoneUpdateTopBar(onBackTap: () => Get.back()),
                  ...
                  _DangerButton(
                    label: 'Hapus Nomor Telepon',
                    onTap: () => _showToast('Hapus nomor tapped'),
                  ),
                ],
              ),
            ),
...
class _PhoneUpdateTopBar extends StatelessWidget {
  final VoidCallback onBackTap;

  const _PhoneUpdateTopBar({required this.onBackTap});
...
class _PhoneField extends StatelessWidget {
  ...
  const _PhoneField({required this.controller, required this.onClear});
...
class _PhoneUpdateBottomNavBar extends StatelessWidget {
  final VoidCallback onCommunityTap;
  final VoidCallback onHomeTap;
  final VoidCallback onProfileTap;

  const _PhoneUpdateBottomNavBar({
