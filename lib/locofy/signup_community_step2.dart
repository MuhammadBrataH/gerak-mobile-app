...
class SignUpCommunityStep2 extends StatefulWidget {
  const SignUpCommunityStep2({super.key});

  @override
  State<SignUpCommunityStep2> createState() => _SignUpCommunityStep2State();
}

class _SignUpCommunityStep2State extends State<SignUpCommunityStep2> {
